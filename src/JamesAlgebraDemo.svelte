<script lang="ts">
  ...
  let formInfos : FormDisplayInfo[] = [
    ...
    makeFormDisplayInfo("[(())]", "basically 1"),
    makeFormDisplayInfo("((()))", "B^B"),
    makeFormDisplayInfo("[[[]]]", "logloglog0"),
    makeFormDisplayInfo("(((())))", "B^(B^B)"),
    makeFormDisplayInfo("[[[[]]]]", "loglogloglog0"),
    makeFormDisplayInfo("([[[]]])", "basically loglog0"),
    makeFormDisplayInfo("[((()))]", "basically #"),
    makeFormDisplayInfo("<<<>>>", "basically void"),
    makeFormDisplayInfo("[(<<>>)]", "basically void"),
    makeFormDisplayInfo("([<<>>])", "basically void"),
